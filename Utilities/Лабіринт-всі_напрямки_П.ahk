...
Run '"C:\Program Files (x86)\S4A\S4A.exe" "C:\Program Files (x86)\S4A\S4A.image" "C:\Users\user\Desktop\Scratch_Projects\Plastic_balance_board\Labyrinth-all_directions.sb"'
WinWait("S4A 1.6")
WinActivate("S4A 1.6")
Sleep 1000
